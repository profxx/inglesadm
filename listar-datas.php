    ...
    if($qtd > 0){
        ...
        while ($row = $res->fetch_object()){
            ...
            print("<td>
                    ...
                    <button onclick=\"if(confirm('Pagamento na data de hoje?')){location.href='?page=salvar&acao=cadastrar-pgto&id=".$row->id."';}else{false;}\" type='button' class='btn btn-outline-success' target='listar-pgto.php'>Incluir Pagamento</button>
                    </td>");
            print('</tr>');
        }
        print('</table>');
